 ...
 */
'use strict';
// Reworked helpers from chart.js-4.3.0.tgz\chart.js-4.3.0.tar\package\dist\chunks\helpers.segment.cjs
define(['libraries/color.min'], function(color$1) {
  const exports = {};
  /**
